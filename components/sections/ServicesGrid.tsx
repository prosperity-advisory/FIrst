          ...
          {services.map((service, i) => {
            ...
            return (
              <FadeUp key={service.title} delay={delayGroup} className="group">
                <div className="bg-white p-7 sm:p-8 lg:p-10 2xl:p-11 rounded-lg border border-border border-t-[3px] border-t-transparent transition-all duration-[400ms] hover:-translate-y-1.5 hover:shadow-[0_16px_48px_rgba(20,57,43,0.1)] hover:border-t-gold">
                  {/* Icon */}
