...
import { updateSectionContent, uploadImage } from "@/app/admin/actions";
...
function ArrayField({
  ...
  // Compute summary: first text/textarea field value
...
function setNestedValue(
  ...
  // If the next segment is a numeric index, we're updating an array
